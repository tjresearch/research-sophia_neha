...
def body_frames(output_folder): # output folder = VID_TEST_CASE_# without the keypoints at the end
    ...
    # commpath = r'C:\Users\1707612\PycharmProjects\SeniorResearch\research-sophia_neha-master\research-sophia_neha-master\output\video_output'
...
def frame_parse(filepath):  # takes number on the file name, {0:012d} formats num with 0's in front
    # filepath = "../output/video_output/{0:}_keypoints/{0:}_{1:012d}_keypoints.json".format(output_folder, frame_num)
    json_frame = open(filepath, 'r')
    # json_frame = open(filepath)
    print(filepath)
...
# frame_num = 234
# filepath = "../output/video_output/{0:}/{0:}_{1:012d}_keypoints.json".format(output_folder, frame_num)
# print(filepath)
# print(frame_parse(folder, 234));
body_frames(folder)
